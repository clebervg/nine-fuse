...
void main() {
  group('recompensa do dígito máximo', () {
    ...
    test('criar o dígito máximo produz uma fusão de dígito máximo', () {
    ...
    // O Bloco 9 (o 9 criado por combinação de 3-4 peças) não paga mais
    // movimentos-bônus — decisão do spec: ele só limpa bloqueador ao redor.
    // Quem devolve saldo hoje é a ativação do Super 9, que não passa por
    // `_finishMove`/`resolution` (ver `game_notifier.dart`).
    test('criar o dígito máximo não altera o saldo de movimentos', () {
